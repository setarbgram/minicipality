...
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            date: "لطفا تاریخ معتبر وارد نمایید.",
            dateISO: "Please enter a valid date ( ISO ).",
            number: "لطفا شماره معتبری وارد کنید.",
            digits: "وارد کردن اعداد مجاز است.",
            creditcard: "لطفا شماره کارت اعتباری معتبر وارد نمایید..",
            equalTo: "لطفا تکرار رمز عبور را به درستی وارد نمایید..",
            maxlength: a.validator.format("لطفا فیلد وارد شده بیشتر از {0} کارکتر نباشد.."),
            minlength: a.validator.format("فیلد مربوطه حداقل باید {0} کاراکتر باشد."),
            rangelength: a.validator.format("لطفا Enter Number must be between {0} - {1}"),
            range: a.validator.format("اعداد  وارد شده باید بین بین {0} - {1} باشد."),
            max: a.validator.format("لطفا داده ی وارد شده کوچکتر یا مساوی {0} باشد."),
            min: a.validator.format("لطفا داده ی وارد شده بزرگتر یا مساوی {0}.باشد")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
