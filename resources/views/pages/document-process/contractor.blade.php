                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <input class="form-control" type="text" name="contractNumber" id="contractNumber" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <input class="form-control" type="text" name="commitmentNumber" id="commitmentNumber" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        ...
                                        <input class="form-control" type="text" name="contractPeriod" id="contractPeriod" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        ...
                                        <select class="form-control" type="text" name="peinmankarChoice" id="peinmankarChoice" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <input class="form-control" type="text" name="tavafohnameDate" id="tavafohnameDate" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        ...
                                        <input class="form-control" type="text" name="komesionMoamelatNum" id="komesionMoamelatNum" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <input class="form-control" type="text" name="komesionMoamelatNumDate" id="komesionMoamelatNumDate" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        ...
                                        <input class="form-control" type="text" name="monagheseSessionNumber" id="monagheseSessionNumber" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <input class="form-control" type="text" name="monagheseSessionNumberDate" id="monagheseSessionNumberDate" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        ...
                                        <input class="form-control" type="text" name="permissionNumber" id="permissionNumber" >
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <input class="form-control" type="text" name="permissionNumberDate" id="permissionNumberDate" >
