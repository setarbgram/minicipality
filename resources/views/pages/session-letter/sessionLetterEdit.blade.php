                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <select class="form-control" type="text" name="contractID" id="contractID">
                                            @foreach($cotractNum as $num)
                                                <option value="{{$num}}" {{($session['contractID']==$num)?"Selected":""}}>{{$num}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-4  form-txt-align "><label
                                                class="control-label label-position"
                                                for="typeNO">نوع صورت جلسه:</label>
                                    </div>
                                    <div class="col-lg-7 col-sm-8 form-group ">

                                        <select class="form-control" type="text" name="typeNO" id="typeNO">
                                            @foreach($types as $type)
                                                <option value="{{$type['typeNO']}}" {{($session['typeNO']==$type['typeNO'])?"Selected":""}}>{{$type['type']}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-4 form-txt-align ">
                                        <label class="control-label label-position" for="recordID">شماره ی
                                            صورت جلسه: </label>
                                    </div>

                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="recordID" id="recordID"
                                               value="{{$session['recordID']}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        ...
                                        <input class="form-control" type="text" name="communicationID"
                                               id="communicationID" value="{{$session['communicationID']}}">
