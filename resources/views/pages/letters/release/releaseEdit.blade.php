...
@section('contents')
    ...
    <form role="form" id="form" method="post" action="{{route('release-update',$release['id'])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <select class="form-control" type="text" name="contractID" id="contractID">
                                            @foreach($cotractNum as $num)
                                                <option value="{{$num}}" {{($release['contractID']==$num)?"Selected":""}}>{{$num}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-4  form-txt-align "><label
                                                class="control-label label-position"
                                                for="releaseType">نوع آزادسازی :</label>
                                    </div>
                                    <div class="col-lg-7 col-sm-8 form-group ">

                                        <select class="form-control" type="text" name="releaseType" id="releaseType">
                                            @foreach($types as $type)
                                                <option value="{{$type['typeNO']}}" {{($release['releaseType']==$type['typeNO'])?"Selected":""}}>{{$type['type']}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationID"
                                               id="communicationID" value="{{$release['communicationID']}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationDate" readonly
                                               ...
                                               value="{{($release['communicationDate'])?\App\Helper\toPersianDate($release['communicationDate']):''}}">
