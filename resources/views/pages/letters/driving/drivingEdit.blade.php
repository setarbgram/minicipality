...
@section('contents')
    ...
    <form role="form" id="form" method="post" action="{{route('driving-update',$driving['id'])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>ویرایش راهنمایی و رانندگی</h5>
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <select class="form-control" type="text" name="contractID" id="contractID">
                                            @foreach($cotractNum as $num)
                                                <option value="{{$num}}" {{($driving['contractID']==$num)?"Selected":""}}>{{$num}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationID"
                                               id="communicationID"  value="{{$driving['communicationID']}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationDate" readonly
                                               ...
                                               value="{{($driving['communicationDate'])?\App\Helper\toPersianDate($driving['communicationDate']):''}}">
