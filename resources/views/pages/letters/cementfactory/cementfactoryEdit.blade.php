...
@section('contents')
    ...
    <form role="form" id="form" method="post" action="{{route('cementfactory-update',$cementfactory['id'])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <input type="hidden" name="cementfactoryId" id="cementfactoryId" value="{{$cementfactory['id']}}" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationID"
                                               id="communicationID" value="{{$cementfactory['communicationID']}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationDate" readonly
                                               ...
                                               value="{{($cementfactory['communicationDate'])?\App\Helper\toPersianDate($cementfactory['communicationDate']):''}}">
