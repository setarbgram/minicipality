...
@section('contents')
    ...
    <form role="form" id="form" method="post" action="{{route('notifications-update',$notification['id'])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group ">
                                        ...
                                        <select class="form-control" type="text" name="contractID" id="contractID">
                                            @foreach($cotractNum as $num)
                                                <option value="{{$num}}" {{($notification['contractID']==$num)?"Selected":""}}>{{$num}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-4 form-txt-align ">
                                        <label class="control-label label-position" for="subject">
                                            موضوع نامه : </label>
                                    </div>

                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="subject"
                                               id="subject" value="{{$notification['subject']}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationID"
                                               id="communicationID"  value="{{$notification['communicationID']}}">
                                    </div>
                                </div>
                            </div>
                            <div class=" col-lg-6 col-sm-12 col-xs-12  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-8 form-group">
                                        <input class="form-control" type="text" name="communicationDate"
                                               id="communicationDate"  value="{{$notification['communicationDate']}}">
                                    </div>
                                </div>
                            </div>
                        </div>
